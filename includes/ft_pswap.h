...
/*   Updated: 2020/07/28 15:15:08 by sassassi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_correct				*ft_calc_all_variants(t_stack **top_a,
					t_stack **top_b, t_stack *elem_b,
					t_correct **top_correct);
void					ft_visualize(t_stack **top_a,
					t_stack **top_b, char *line);
...
void					ft_markuping(t_stack **top,
					int (*mark_f)(t_stack**, t_stack*), t_help *help);
void					ft_three_elem_sort_a(t_stack **top_a,
					t_stack **top_b, int fd, int mid);
...
int						ft_get_minval_index(t_stack **top,
						int value, int size);
